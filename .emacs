...
(custom-set-variables
 ...
 '(liquid-types/trigger (quote double-mouse-1))
 '(nrepl-message-colors
   (quote
    ("#CC9393" "#DFAF8F" "#F0DFAF" "#7F9F7F" "#BFEBBF" "#93E0E3" "#94BFF3" "#DC8CC3")))
 '(package-selected-packages
   (quote
    (company-lean helm-lean lean-mode company-racer proof-general helm-idris flycheck-liquidhs liquid-types hindent unicode-fonts company-coq cargo flycheck-rust racer rust-mode rustfmt company-anaconda anaconda-mode utop flycheck-ocaml tuareg helm zenburn-theme undo-tree ujelly-theme sml-mode scala-mode2 sbt-mode racket-mode pos-tip popup paredit nyan-mode markdown-mode magit magic-latex-buffer idris-mode flycheck-stack flycheck-haskell flycheck-color-mode-line exec-path-from-shell dirtree csv-mode company color-theme-sanityinc-tomorrow button-lock)))
...
(setq-default flycheck-disabled-checkers '(coq haskell))
